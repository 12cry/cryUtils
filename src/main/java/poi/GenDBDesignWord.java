...
public class GenDBDesignWord {
	...
	static {
		...
		try {
			template = new XWPFDocument(new FileInputStream("E:/template.docx"));
	...
	public Map<String, Map<String, List<Map<String, Object>>>> toModuleMap(List<Map<String, Object>> list, String key) {
		...
		for (String code : map.keySet()) {
			...
			String module = code.indexOf("_", code.indexOf("_") + 1) == -1 ? code.substring(code.indexOf("_") + 1)
	...
	public void getDocAction(XWPFDocument doc, List<Map<String, Object>> tableList, List<Map<String, Object>> viewList,
			List<Map<String, Object>> indexList) throws Exception {

		Map<String, Map<String, List<Map<String, Object>>>> tableModuleMap = this.toModuleMap(tableList, TABLE_CODE_KEY);
		Map<String, Map<String, List<Map<String, Object>>>> viewModuleMap = this.toModuleMap(viewList, VIEW_CODE_KEY);
		// Map<String, Map<String, List<Map<String, Object>>>> indexModuleMap =
		// this.toModuleMap(indexList, INDEX_CODE_KEY);
		Map<String, List<Map<String, Object>>> map;
		for (String module : MODULE_CODE_ARRAY) {
