...
public class Main {
	...
	public void gen() throws Exception {
		XWPFDocument template = new XWPFDocument(new FileInputStream("C://files/template/wordTemplate.docx"));
...
//				r.setText("5." + title1 + "." + title2++ + ". " + s2);
	...
	public void genAction(XWPFDocument doc, List<Map<String, Object>> list) throws Exception {
